...
If the numerical representation is provided there must be a corresponding
NID in OpenSSL's codebase.

OBJ_txt2obj() converts the text string B<s> into an ASN1_OBJECT structure.
If B<no_name> is 0 then long names and short names will be interpreted
first, as well as numerical forms. If B<no_name> is 1 only the numerical
form is acceptable.
Unlike OBJ_txt2nid() the numerical, "dotted" form, (eg. 1.2.3.45) can be
used with any objects, not just registered ones.
